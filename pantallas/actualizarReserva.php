...
<body>
    <form action="../backend/reservaActualizar.php" method="GET">
        <div class="wrapper">
            <?php include("../templates/navbar.php"); ?> <!-- navbar -->
            <?php include("../templates/sidebar.php"); ?> <!-- sidebar -->

            <!-- Contenido de Actualizar Reserva -->
                    ...
                    <div class="container-fluid">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <?php if($row['tipo'] == "Operador") {?>
                                    <li class="breadcrumb-item"><a href="listaReservas.php">Lista de Reservas</a></li>
                                <?php } else {?>
                                    <li class="breadcrumb-item"><a href="verReservas.php">Mis Reservas</a></li>
                                <?php }?>
                                <li class="breadcrumb-item active" aria-current="page">Actualizar Reserva</li>
                            </ol>
                        </nav>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title text-center">Datos de la Reserva <input class="form-control text-center" type="text" name="codigo"
                                                id="codigo" value="<?php echo $a; ?>" readonly> 
                                        </div>
                                        <div>
                                            <?php
                                                if(isset($_GET["fallo"]) && $_GET["fallo"] == 'true')
                                                {
                                                    echo "<div style='color:#B9181F'><b>No se ha actualizado la reserva correctamente. Intente otra vez.</b></div>";
                                                }
                                                else if(isset($_GET["succ"]) && $_GET["succ"] == 'true')
                                                {
                                                    echo "<div style='color:green'><b>¡Reserva actualizada correctamente!</b></div>";
                                                }
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title text-center">Actualizar Reserva</div>
                                    </div>
                                    <div class="card-body">
                                        <div class="">
                                            <div class="text-center">
                                                ...
                                                <button type="button" class="btn btn-success"
                                                    id="actualizaReserva" onclick="abrirAceptarModal()" data-toggle="modal" data-target="#modalAceptar">Aceptar</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-info">
                                <h6 class="modal-title"><i class="la la-calendar-check-o"></i> Actualizar Reserva </h6>
