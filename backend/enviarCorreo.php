<?php
  function EnviarCorreo($correo_usuario,$nombre,$apellido,$cedula,$contra)
  {
          ...
          $para4='alexander.alveo@utp.ac.pa';
          // título
          $asunto = 'Activación de Cuenta en Sistema de Laboratorios FISC';
          // mensaje
          $mensaje = '
          <html>
          <head>
          <title>ACTIVACION DE CUENTA EN SISTEMA DE LABORATORIOS FISC</title>
          </head>
          <body>
            ...
            <tr>
              <td bgcolor="#f5ffde"><p align="center"><strong>'.$nombre.' '.$apellido.' '.$cedula.'</strong> <br>
                Usted ha sido registrado en nuestro sistema de forma exitosa<br>
                  Para acceder al sistema hará uso del correo '.$correo_usuario.' y la contrase&ntildea '.$contra.' a continuaci&oacuten le adjuntamos el enlace de acceso al sistema; le recordamos cambiar su contrase&ntildea.</p>
